...
public class _03_FindTheHiddenButton implements ActionListener{
    ...
    public void start() {
        ...
        String hiddenButtonString = JOptionPane.showInputDialog("Ask me for a number!");
        buttons = new JButton[Integer.parseInt(hiddenButtonString)];
        ...
        JOptionPane.showMessageDialog(null, "find the hidden button idiot");
        // 13. initialize the hiddenButton variable to a random number less than
        //     the int created in step 3
        Random ran = new Random();
        hiddenButton = ran.nextInt(buttons.length);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == buttons[hiddenButton]) {
        	JOptionPane.showMessageDialog(null, "praise the sun!");
        }
